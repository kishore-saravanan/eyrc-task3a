    ...
    if len(corners) > 0:
        ...
        for (markerCorner, markerID, i) in zip(corners, ids, total_markers):
            ...
            if area > aruco_area_threshold: 
                ...
                center_aruco_list.append((cX, cY))  # Assuming you calculate cX and cY
...
class aruco_tf(Node):
    ...
    def process_image(self):
        ...
        for i in range(len(ids)):
            ...
            child_frame = f'1243_cam_{marker_id}'
            ...
            child_frame = f'1243_base_{marker_id}'
            ...
            self.obj_frames.append(f'1243_base_{marker_id}')
